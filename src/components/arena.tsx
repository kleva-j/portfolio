...
type Showcase = {
  name: string;
  tagline: string;
  to: "/arena/design-arena" | "/arena/canvas-crowd" | "/arena/activity-heatmap";
};

const showcases: Showcase[] = [
  {
    name: "Design Arena",
    tagline: "Interactive 3D bookshelf — WebGL, instanced geometry, camera work.",
  ...
  return (
    <FeatureCard className="p-0">
      <div className="relative z-10">
        ...
        <ul className="grid grid-cols-1 divide-y divide-border border-t border-border sm:grid-cols-3 sm:divide-x sm:divide-y-0">
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2">
        ...
        <ArrowUpRightIcon
          className="size-3.5 shrink-0 text-muted-foreground transition-all group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-primary motion-reduce:transition-none"
          weight="bold"
        />
      </div>
